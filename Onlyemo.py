...
emotions = pipeline("text-classification", tokenizer=emoTokenizer, max_length=500, model=emoModel, return_all_scores=True, device=0)
...
emoInputList = []
for emoi in newsBody.index:
    emoInputList.append(emotions(str(newsBody.iloc[emoi, 0])))
